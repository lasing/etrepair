...
<body>
	<div style="height: 100%;">
		<table id="dg" title="" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th width="5%" data-options="field:'isEnable',align:'center',formatter:formatIsEnable">是否可用</th>
					<th field="pointNumber" width="8%">ET网点编号</th>
					<th width="8%" data-options="field:'expDate',formatter:toLocalFullDate">合作有效期</th>
		...
		<div id="toolbar">
			<table class="xw_search_tb">
				...
				<tr>
					<td colspan=3 " style="text-align: right; padding:15px 15px 0px 0px;">
			...
			<c:if test="${ empty isReadOnly || !isReadOnly}">
				<div style="padding:0px 0px 5px 5px;">
					...
					</a> --><a href="javascript:void(0)"  class="main-bott xz-bott-i "
						onclick="newGarage()" plain="true"> <i
						class="fa fa-plus-square-o"></i>&nbsp;新增
					</a>
					 <a href="javascript:void(0)" class="main-bott bji-bott-i "
						onclick="doUpdateRecord()" plain="true"> <i
						class="fa fa-pencil-square-o"></i>&nbsp;编辑
					</a>  <a href="javascript:void(0)" id="viewGarage" class="main-bott ck-bott-i "
						onclick="doShowRecord()" plain="true"> <i class="fa fa-search"></i>&nbsp;查看
					</a> 
					<a href="javascript:void(0)" class="main-bott sc-bott-i "
	...
	<!-- 新增窗口 -->
	<div id="dlg" class="easyui-dialog" style="width: 850px; height: 500px;"
		 closed="true"
		buttons="#dlg-buttons">
		...
		<div style="height: 100%;">
			<table id="dg_core" title="新增" class="easyui-datagrid"
				...
				<thead>
					<tr>
						<th width="30" data-options="field:'isExists',align:'center',formatter:formatIsExists">是否存在</th>
			...
			<div id="toolbar_add">
				<table class="xw_search_tb BJ-tab">
					...
					<tr class="tb-bj pdd-bot">
						...
						<td width="40%"><label class="lab-tb-BJ">组织机构：</label>
							<input id="search_core_orgId" name="search_orgId" class="easyui-combobox"
							style="height: 28px;  width:150px;"
							data-options="valueField:'id',textField:'text'" /></td>
					</tr>
					<tr>
						<td colspan="2" style="text-align: right; padding:15px 15px 15px 0px;"><a
							href="javascript:void(0)" class="easyui-linkbutton" plain="true"
							onclick="doAddSearch()"
							style="background: #6bb1e6; color: white; width: 100px;">查询</a> <a
							href="javascript:void(0)" class="easyui-linkbutton" plain="true"
	...
	<div id="dlg-update" class="easyui-dialog"
		...
		<form id="fm_update" method="post" novalidate>
			<table class="tckuang">
				<tr>
					<td><label class="lab-tb-BJ">ET网点编号：</label> <input id="dlg-update_pointNumber"
					name="pointNumber" class="easyui-textbox" style="height:28px; " data-options="required:true,validateOnBlur:true" 
					validType="pointNumberValidator"></td>
					
					<td><label class="lab-tb-BJ">联系人：</label> <input id="dlg-update_contact"
					name="contact" class="easyui-textbox" style="height:28px;"data-options="required:true,validateOnBlur:true" 
					 validType="contactValidator"></td>
				</tr>
				<tr>
					<td><label class="lab-tb-BJ">联系电话：</label> <input id="dlg-update_contactPhone"
					name="contactPhone" class="easyui-textbox" style="height:28px;" data-options="required:true,validateOnBlur:true"
					validType="contactPhoneValidator"></td>
					<td><label class="lab-tb-BJ">修理厂简称：</label> <input id="dlg-update_garageNameAbb"
					name="garageNameAbb" class="easyui-textbox" style="height:28px;" data-options="required:true,validateOnBlur:true" 
					validType="garageNameAbbValidator"></td>
				</tr>
				<tr>
					<td><label class="lab-tb-BJ">地址简称：</label> <input id="dlg-update_garageAddrAbb"
				name="garageAddrAbb" class="easyui-textbox" style="height:28px;" data-options="required:true,validateOnBlur:true"
				validType="garageAddrAbbValidator"></td>
					<td><label class="lab-tb-BJ">修理厂地址：</label> <input id="dlg-update_garageAddr"
				name="garageAddr" class="easyui-textbox" style="height:28px;" data-options="required:true,validateOnBlur:true"
				validType="garageAddrValidator"></td>
				</tr>
				<tr>
					<td><label class="lab-tb-BJ">经度：</label> <input id="dlg-update_longitude"
				 name="longitude"  class="easyui-textbox" style="height:28px;" disabled="disabled"></td>
					<td><label class="lab-tb-BJ">纬度：</label> <input id="dlg-update_latitude"
				 name="latitude" class="easyui-textbox" style="height:28px;" disabled="disabled"></td>
				</tr>
				<tr>
					<td><label class="lab-tb-BJ">合作有效期：</label> <input id="dlg-update_expDate"
					name="expDate" class="easyui-datebox" data-options="required:true,validateOnBlur:true" style="height:28px;"
					data-options="required:true,validateOnBlur:true" ></td>
					<td><label class="lab-tb-BJ">任务上限数：</label> <input id="dlg-update_tasklimit"
					name="tasklimit" class="easyui-textbox" style="height:28px;" data-options="required:true,validateOnBlur:true"
			    ...
			    <tr>
					...
					<td colspan="2">
					<input id="dlg-update_categoryCode" name="categoryCode"
				      class="easyui-textbox"  type="hidden"/>
					</td>
			   </tr>
			
			<tr>
				<td colspan="2" style="text-align: right;"><label class="lab-tb-BJ">服务特色：</label>
					<textarea rows="5" cols="70" id="dlg-update_serviceFeature" name="serviceFeature" style="resize: none;"></textarea>
			</td>
			</tr>
