...
public class BrowseTool {
    private final static String IE11Code = "like Gecko";
    ...
    public static String checkBrowse(String userAgent) {
        ...
        if (regex(IE11Code, userAgent)) return IE11;
    ...
    //
    // String chrome1 = "Chrome 49.0.2623";
    //
    ...
    //
    // System.out.println(b.checkBrowse(chrome1));
    //
    //
    // System.out.println(b.checkBrowse("Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36"));
    //
    // }
}
